package com.deili.deilimanagement.exception;

import com.deili.deilimanagement.response.Response;
...
public class GlobalExceptionHandler {
    ...
    public final ResponseEntity<Response<String>> handleProductNotFoundException(EntityNotFoundException ex){
