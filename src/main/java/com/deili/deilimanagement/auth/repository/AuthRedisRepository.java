package com.deili.deilimanagement.auth.repository;
...
public class AuthRedisRepository {
    private static final String STRING_KEY_PREFIX = "deilimanagement:jwt:strings:" ;
    private static final String STRING_BLACKLIST_KEY_PREFIX = "deilimanagement:blacklist-jwt:strings:" ;
